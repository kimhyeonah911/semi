...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<Product> selectProductList(int clientId, int storeId) {
        return productMapper.selectProductList(clientId, storeId);
    }

    @Override
    public List<Product> searchProductName(String productName, int clientId) {
        return productMapper.searchProductName(productName, clientId);
    }
